...
import type { DashboardCandidate, TableColumn, PaginationState } from '../../../types/dashboard';
        ...
        {candidates.length > 0 && (
          <div className="border-b border-white/[0.06] py-4 px-4 flex items-start opacity-50">
            <div className="w-10 text-center">
              <span className="inline-block w-3.5 h-3.5 text-gs-text-darker">*</span>
            </div>
            <div className="ml-4">
              <span className="repo-chip">langchain-ai/langchain</span>
            </div>
          </div>
        )}
      </div>
